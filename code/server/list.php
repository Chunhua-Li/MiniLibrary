...
<head>
  ...
  <title>My collection - Mini Library</title>
</head>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  // Add conditions for other fields if they are provided
  if (!empty($title)) {
...
<nav>
  My collection&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="otherslist.php">Others collection</a>
</nav>
<main>
<div id="content">
    <div class="logout">
    ...
    <div>
      ...
      <?php while($results = mysqli_fetch_assoc($result_set)) { ?>
        <tr>
          ...
          <td><a class="plainlink" href="<?php echo"display.php?id=" . $results['id']?>"><?php echo $results['title']; ?></a></td>
          ...
          <td><a class="lista" href="<?php echo "update.php?id=" . $results['id']; ?>">Edit</a></td>
          <td><a class="lista" href="<?php echo "remove.php?id=" . $results['id']; ?>">delete</a></td>
    	  </tr>
      <?php } 
      db_disconnect($db);
      ?>
